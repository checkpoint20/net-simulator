...
public class RouterNetworkShape
    ...
    public static void setSkin( String skin, ShapeInfo shapeInfo ) {
        RouterNetworkShape.skin = skin;
        RouterNetworkShape.shapeInfo = shapeInfo;

        image = Toolkit.getDefaultToolkit().createImage( "img/" + skin + "/router.gif" );
        selectedImage = Toolkit.getDefaultToolkit().createImage( "img/" + skin + "/router_s.gif" );
        hilightedImage = Toolkit.getDefaultToolkit().createImage( "img/" + skin + "/router_h.gif" );
    }
